 ...
 */
public class PopWindow_ChooseImage extends PopupWindow {
    private Button btn_take_photo, btn_pick_photo, btn_cancel;
    private View mMenuView;

    public PopWindow_ChooseImage(Activity context, View.OnClickListener itemsOnClick) {
        super(context);
        LayoutInflater inflater = (LayoutInflater) context
                .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        mMenuView = inflater.inflate(R.layout.part_popwindow_choose_image, null);
        btn_take_photo = (Button) mMenuView.findViewById(R.id.camera_take);
        btn_pick_photo = (Button) mMenuView.findViewById(R.id.camera_choose);
        btn_cancel = (Button) mMenuView.findViewById(R.id.camera_exit);
