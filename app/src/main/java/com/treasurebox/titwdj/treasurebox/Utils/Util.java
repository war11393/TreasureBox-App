...
public class Util {
    ...
    //为拟图配置半随机的底色---根据文字的hashcode设置固定的底色
    private static class ColorUtils {
        ...
        public static int getRandomColor(@IntRange(from = RANDOM_COLOR_START_RANGE, to = RANDOM_COLOR_END_RANGE)
            ...
            if (colorNmae.contains("1")) {
                resId = Color.parseColor("#DDF3FF");
            } else if (colorNmae.contains("2")) {
                resId = Color.parseColor("#6699CC");
            } else if (colorNmae.contains("3")) {
                resId = Color.parseColor("#66CCCC");
            } else if (colorNmae.contains("4")) {
                resId = Color.parseColor("#B45B3E");
            } else if (colorNmae.contains("5")) {
                resId = Color.parseColor("#479AC7");
            } else if (colorNmae.contains("6")) {
                resId = Color.parseColor("#00B271");
            } else if (colorNmae.contains("7")) {
                resId = Color.parseColor("#E8D098");
            } else {
                resId = Color.parseColor("#F0DAD2");
            }
            return resId;
        }
